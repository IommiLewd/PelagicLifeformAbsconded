class Laboratory extends Phaser.State {
    constructor() {
        super();
    }
    ...
    _loadLevel() {
        ...
        this._backgroundImage = this.game.add.image(0, 0, 'tilesetLaboratory');
    ...
    _addNarrator(){
        this.narrator = new Narrator(this.game, 768, 134, 'rowan', 1);
    }
    _checkCollision() {
